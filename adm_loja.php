...
if(isset($_POST['cadastrar'])){
	if($_POST['nome'] !="" && $_POST['email'] !="" && $_POST['senha'] !="" && $_POST['senha2'] !="" && $_POST['telefone'] !="" && $_POST['logradouro'] !="" && $_POST['numero'] !="" && $_POST['bairro'] !="" && $_POST['cidade'] !="" && $_POST['uf'] !="" && $_POST['cep'] !="" && $_POST['senha'] == $_POST['senha2']){
...
$sql = "INSERT INTO loja(id, usuario_id, logradouro, numero, bairro, cidade, complemento, uf, cep) VALUES(null, '".$linha['id']."', '".$logradouro."', '".$numero."', '".$bairro."', '".$cidade."', '".$complemento."', '".$uf."', '".$cep."')";
$dados = mysqli_query($conexao, $sql);
...
<section id="nav-slide">
	...
	<div class="container">
		...
		<form method="post" action="adm_loja.php">
			<div class="row">
				<div class="col-md-4">
